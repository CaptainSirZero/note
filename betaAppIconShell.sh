...
# 遮罩
    ...
    convert /tmp/blurred.png -gamma 0 -fill black -draw "rectangle 0,$band_position,$width,$height" /tmp/mask.png
    convert -size ${width}x${band_height} xc:none -fill 'rgba(256,0,0,1)' -draw "rectangle 0,0,$width,$band_height" /tmp/labels-base.png
# 文字lable -annotate 45(角度)
